...
- **Prisma:** V4 Contract Master models are on `main` (`nursing_employment_contracts`, agencies, alerts, …).
- **Nest:** `backend/src/modules/nursing/nursing.service.ts` was briefly corrupted by a failed bulk push. **Restore it before deploying:**
